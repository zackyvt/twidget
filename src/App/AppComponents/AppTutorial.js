...
export default class AppTutorial {
    ...
    parseTutorialData(){
        return new Promise((resolve, reject) => {
            fs.readFile('./src/assets/templates/tutorial.html', 'utf8' , (err, data) => {
                if (err) {
                  console.error(err)
                  reject(err);
                }
